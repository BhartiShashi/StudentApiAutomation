...
public class TC004_Put_Student_Record extends TestBase {
	...
	@BeforeClass
	void updateEmployee() throws InterruptedException, JSONException {
		logger.info("*********Started TC004_Put_Student_Record **********");
...
//
	...
	void tearDown()
	{
		logger.info("*********  Finished TC004_Put_Student_Record **********");
	}
